/* Multiplying big numbers which are out of bounds.(Mostly used for big factorial calculation.). 
 * 
*/
#include <stdio.h>
...
int main() {
    ...
    while(n2)  { 
		// Store n2 in an array digit-by-digit
        a[m++] = n2 % 10;
        n2 /= 10;
    }
    ...
    while(temp)  {
		// Loop that will store the remaining carry value on resultant array, if any
        res[m++] = temp % 10;
        temp /= 10;
    }
